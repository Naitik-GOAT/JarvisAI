...
System = f"""Hello, I am {Username}, You are a very accurate and advanced AI chatbot named {Assistantname} with extensive knowledge.
...
def ChatBot(Query):
    ...
    try:
        ...
        # Make a request to the Group API for a response.
        completion = client.chat.completions.create(
            model="llama3-70b-8192",  # The AI model to use.
