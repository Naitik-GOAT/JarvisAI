...
from dotenv import dotenv_values  # Import dotenv for reading environment variables from a .env
...
# ⬇️ The if __name__ == "__main__" block moved here at the top-level
